...
$connect = new PDO("mysql:host=localhost;dbname=blog_test", "root", "");
$query = "SELECT * FROM tbl_post ORDER BY is DESC";
...
$base_url = "http://localhost/wundeNormal/news.php";
...
foreach ($result as $row)
{
    ...
    echo "<link>" .$base_url . "news/" . $row["post_url"] . "</link>" . PHP_EOL;
